...
public class LitemallOrder {
    ...
    public String getOrderOriSn() {
        return orderOriSn;
    }

    public void setOrderOriSn(String orderOriSn) {
        this.orderOriSn = orderOriSn;
    }
    ...
    public void setSailer(String sailer) {
        this.sailer = sailer;
    }
